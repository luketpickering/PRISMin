...
std::array<TH1D *, 8> NDFluxOnAxisStroboTimeBin;
...
int main(int argc, const char *argv[]) {
  ...
  NDFlux_293kA = PRISMFluxesFile.Get<TH2D>("ND_293kA_nub_numubar");
  NDFlux_280kA = PRISMFluxesFile.Get<TH2D>("ND_280kA_nub_numubar");
  FDFlux = PRISMFluxesFile.Get<TH1D>("FD_nub_numubar");
  ...
  size_t NNDStroboTimeBins = 8;
  NDFluxOnAxisStroboTimeBin[0] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_under");
  NDFluxOnAxisStroboTimeBin[1] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin0");
  NDFluxOnAxisStroboTimeBin[2] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin1");
  NDFluxOnAxisStroboTimeBin[3] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin2");
  NDFluxOnAxisStroboTimeBin[4] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin3");
  NDFluxOnAxisStroboTimeBin[5] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin4");
  NDFluxOnAxisStroboTimeBin[6] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin5");
  NDFluxOnAxisStroboTimeBin[7] =
      StroboNDFluxesFile.Get<TH1D>("BeamEspect_vmubar_bin6");
  ...
  //              NDBinMapping_PRISMAltHC, {0.8, 5});
  SolveAndDraw(NDFluxMatrix_PRISMAltHC, 5E-2, TargetFlux,
               NDBinMapping_PRISMAltHC, {0.8, 5});
  ...
  // SolveAndDraw(NDFluxMatrix_PRISMNoAltHC, 2.5E-2, TargetFlux,
  //              NDBinMapping_PRISMNoAltHC, {0.8, 5});
  SolveAndDraw(NDFluxMatrix_PRISMNoAltHC, 5E-2, TargetFlux,
               NDBinMapping_PRISMNoAltHC, {0.8, 5});
  // SolveAndDraw(NDFluxMatrix_PRISMNoAltHC, 7.5E-2, TargetFlux,
  //              NDBinMapping_PRISMNoAltHC, {0.8, 5});

  // SolveAndDraw(NDFluxMatrix_PRISMStroboNoAltHC, 1E-2, TargetFlux,
  //              NDBinMapping_PRISMStroboNoAltHC, {0.8, 5});
  // SolveAndDraw(NDFluxMatrix_PRISMStroboNoAltHC, 2.5E-2, TargetFlux,
  //              NDBinMapping_PRISMStroboNoAltHC, {0.8, 5});
  SolveAndDraw(NDFluxMatrix_PRISMStroboNoAltHC, 5E-2, TargetFlux,
               NDBinMapping_PRISMStroboNoAltHC, {0.8, 5});
  // SolveAndDraw(NDFluxMatrix_PRISMStroboNoAltHC, 7.5E-2, TargetFlux,
  //              NDBinMapping_PRISMStroboNoAltHC, {0.8, 5});

  // SolveAndDraw(NDFluxMatrix_PRISMStroboAltHC, 1E-2, TargetFlux,
  //              NDBinMapping_PRISMStroboAltHC, {0.8, 5});
  // SolveAndDraw(NDFluxMatrix_PRISMStroboAltHC, 2.5E-2, TargetFlux,
  //              NDBinMapping_PRISMStroboAltHC, {0.8, 5});
  SolveAndDraw(NDFluxMatrix_PRISMStroboAltHC, 5E-2, TargetFlux,
               NDBinMapping_PRISMStroboAltHC, {0.8, 5});
  // SolveAndDraw(NDFluxMatrix_PRISMStroboAltHC, 7.5E-2, TargetFlux,
  //              NDBinMapping_PRISMStroboAltHC, {0.8, 5});
  c1.Print("Coeffs.pdf]");
}
